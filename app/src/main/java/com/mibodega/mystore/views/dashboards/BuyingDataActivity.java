...
public class BuyingDataActivity extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setContentView(R.layout.activity_buying_data);
        setContentLayout(R.layout.activity_buying_data);
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("Datos Compras");
        }
